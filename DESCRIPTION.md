...
- Fix regionless PrivateLink account parsing bug where accounts with dashes (e.g., `gnamsrm-vi65876.privatelink`) were incorrectly truncated at the dash, breaking JWT authentication (SNOW-730644, also fixes SNOW-1209099).
