...
from snowflake.sqlalchemy.custom_types import MAP, OBJECT, TEXT
...
def test_insert_map(engine_testaccount, external_volume, base_location, snapshot):
    ...
    """
    Test inserting data into a table with a MAP column type.

    Args:
        engine_testaccount: The SQLAlchemy engine connected to the test account.
        external_volume: The external volume to use for the table.
        base_location: The base location for the table.
        snapshot: The snapshot object for assertion.
    """
